function Program(enh) {
	...
	this.nodes = (enh && typeof enh.nodes !== 'undefined') ? _.clone(enh.nodes) : [];   
...
Program.prototype.delete = function(node_to_delete) {
	this.nodes = _.without(this.nodes, node_to_delete);
};
Program.prototype.delete_at = function(position_to_delete) {
...
// Program.prototype.load_json = function(json){
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
/*
Program.prototype.insert = function(new_nodes, target_node) {
...
Program.prototype.insert_at = function(new_nodes) {
...
Program.prototype.push_at = function(new_node, target_position) {
...
Program.prototype.insert_column = function(col_num) {
	_.each(this.get_nodes(), function(n){
		if(n.position[1]>=col_num) n.position[1]+=1;
	});
};
Program.prototype.insert_row = function(row_num) {
	_.each(this.get_nodes(), function(n){
		if(n.position[0]>=row_num) n.position[0]+=1;
	});
};
Program.prototype.delete_column = function(col_num) {
...
Program.prototype.delete_row = function(row_num) {
	 this.set_nodes(_.filter(pg.panel.get_nodes(), function(n) {
...
///  Node getters
///////////////////////////////////////////////////////////////////
Program.prototype.get_selected_nodes = function() {};

Program.prototype.get_nodes = function() {
	return this.nodes;
};


Program.prototype.get_adjacent_node = function(direction, node, _allNodes) {
...
Program.prototype.get_node_by_id = function(node_id, ref_node, _allNodes) {
	var allNodes = (_allNodes)?_allNodes: this.get_nodes();
...
Program.prototype.get_node_by_position = function(position, _allNodes) {
	var allNodes = (_allNodes)?_allNodes: this.get_nodes();
...
Program.prototype.get_node_by_values = function(_values) {
...
Program.prototype.get_page_trigger_node = function() {
	return _.filter(this.nodes, function(node) {
		return node.P && node.P.type=='trigger' && node.P.param.event_source=='page';
	});
};
Program.prototype.get_next_nodes = function(node, _reachableNodes, _allNodes) {
...
Program.prototype.get_reachable_nodes = function(_starting_nodes, _allNodes, _include_triggers) {
...
Program.prototype.get_informative_nodes = function(nodes) {
...
Program.prototype.get_prev_nodes = function(node, _allNodes) {	
	var allNodes = (_allNodes)?_allNodes: this.get_nodes();
	var prevNodes = [];
	try{
...
Program.prototype.get_ready_nodes = function(_candidateNodes, _allNodes) {
	var allNodes = (_allNodes)?_allNodes: this.get_nodes();
...
Program.prototype.run_node = function(nodeObj, skip_redraw) {
...
Program.prototype.run_triggered_nodes = function(starting_nodes, _nodes, skip_redraw) {
...
Program.prototype.print = function(nodes) {
	var str = "";
	try{
...
Program.prototype.set_nodes = function(_nodes) {
	this.nodes = _nodes;
};
