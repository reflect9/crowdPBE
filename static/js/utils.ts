...
function str2arrayNumber(str): number[] {
	if(str.match(/^\s+$/)) return []; // IF GIVEN STRING IS EMPTY, RETURN EMPTY LIST
    return _.map(str.split(","), function(s: string){ 
...
function str2arrayBoolean(str): boolean[] {
	if(str.match(/^\s+$/)) return []; // IF GIVEN STRING IS EMPTY, RETURN EMPTY LIST
	return _.map(str.split(","), function(s: string){ 
...
function str2array(str): string[] {
	if(str.match(/^\s+$/)) return []; // IF GIVEN STRING IS EMPTY, RETURN EMPTY LIST
	return _.map(str.split(","), function(s: string){ return s.trim(); });	
}
...
function isPredicateArray(arrayOfArray: any[][]) {
